  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<MainProvider>(builder: (context, value, child) {
      return value.leaveload
          ...
          : value.getLeaveOtherListModel.isEmpty
              ? const Center(
              ...
              : ListView.builder(
                  ...
                  itemCount: value.leaveDateList.length,
                  physics: const BouncingScrollPhysics(),
                  itemBuilder: (BuildContext context, int index1) {
                    List<LeaveListModel> filteredLeave = value
                        .getLeaveOtherListModel
                        .where((element) =>
                            value.leaveDateList[index1].dateFormat ==
                            element.dateFormat)
                        .toList();
                    DateTime now = DateTime.now();
                    DateTime date = value.leaveDateList[index1].date;
                                                  ...
                                                  onTap: () {
                                                    ...
                                                    callNext(
                                                        ApplyForLeaveScreen(
                                                            ...
                                                            from: 'EDIT',
                                                            tabIndex: tabIndex,
                                                            editId: items.id,companyid: companyid,subcompany: subcompany),
                                                        context);
                                                  },
                                                  child: Container(
                                                    width: 91,
...
leaveCancelAlert(BuildContext context, String id) {
          ...
          Row(
            ...
            children: [
              Container(
                ...
                width: 100,
                decoration: BoxDecoration(
                  border: Border.all(color: const Color(0xFF0EB177)),
